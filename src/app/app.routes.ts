...
export const routes: Routes = [
  ...
  { path: 'admin-access-control-list', component: AdminAccessControlListComponent },
...
//staff
  ...
  { path: 'security-track-entry-log', component: SecurityTrackEntryLogComponent },
  { path: '', redirectTo: '/security-track-entry-log', pathMatch: 'full' }, 

  { path: 'security-access-control-list', component: SecurityAccessControlListComponent },
